const HARDCODED_LIST = [
    ...
    { id: 2, name: 'María Gómez', email: 'maria.gomez@example.com', active: true, catedra:"Seguridad" },
    { id: 3, name: 'Carlos López', email: 'carlos.lopez@example.com', active: true, catedra:"Seguridad" },
    { id: 4, name: 'Ana Martínez', email: 'ana.martinez@example.com', active: true, catedra:"Seguridad" },
    { id: 5, name: 'Luis Fernández', email: 'luis.fernandez@example.com', active: true, catedra:"Seguridad" },
    { id: 6, name: 'Sofía Ramírez', email: 'sofia.ramirez@example.com', active: true, catedra:"Seguridad" },
    { id: 7, name: 'Diego Torres', email: 'diego.torres@example.com', active: true, catedra:"Seguridad" },
    { id: 8, name: 'Valentina Ruiz', email: 'valentina.ruiz@example.com', active: true, catedra:"Seguridad" },
    { id: 9, name: 'Pedro Sánchez', email: 'pedro.sanchez@example.com', active: true, catedra:"Seguridad" },
    { id: 10, name: 'Lucía Herrera', email: 'lucia.herrera@example.com', active: true, catedra:"Seguridad" },
    { id: 11, name: 'Miguel Castro', email: 'miguel.castro@example.com', active: true, catedra:"Seguridad" },
    ...
    { id: 14, name: 'Paula Morales', email: 'paula.morales@example.com', active: true, catedra:"Seguridad" },
